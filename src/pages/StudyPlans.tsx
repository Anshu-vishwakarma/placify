...
const StudyPlans = () => {
  ...
  const currentPlan = mockStudyPlans[selectedYear];
const total = currentPlan.milestones.length;
const done = currentPlan.milestones.filter(a => a.completed).length;
const progress = Math.round((done / total) * 100);

console.log(`You’ve completed ${progress}% of your plan!`);
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex justify-between text-sm text-gray-600 mt-2">
                <span>{done} of {currentPlan.milestones.length} milestones completed</span>
                <span>{currentPlan.milestones.length - done} remaining</span>
              </div>
            </CardContent>
          </Card>
